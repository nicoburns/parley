...
#[allow(
    ...
    reason = "layout dimensions are small enough for u16 in benchmarks"
)]
                ...
                move |b| {
                    ...
                    GLYPH_CACHES.with(|gc| {
                        if gc.borrow().is_none() {
                            *gc.borrow_mut() = Some(CpuGlyphCaches::new(
                            ...
                            IMAGE_CACHE.with(|ic| {
                                GLYPH_RENDERER.with(|gr| {
                                    ...
                                    if let Some(atlas_pixmap) =
                                        glyph_caches.glyph_atlas.page_pixmap_mut(0)
                                    {
                            ...
                            GLYPH_CACHES.with(|gc| {
                                IMAGE_CACHE.with(|ic| {
                                    GLYPH_RENDERER.with(|gr| {
                                        ...
                                        // glyph_caches.glyph_atlas.print_cache_stats();
                                        ...
                                        //     if let Some(atlas_pixmap) =
                                        //         glyph_caches.glyph_atlas.page_pixmap(page_index)
                                        //     {
